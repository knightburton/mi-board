      ...
      <div className="container-fluid">
        ...
        <div className="row justify-content-center mt-4">
          <div className="col-auto">
            {active ? (
              <div className="btn btn-outline-danger v" onClick={() => handleStopClick(intervalId)}>
                Stop
              </div>
            ) : (
              <button className="btn btn-outline-success btn-sm" disabled={round > repeat} onClick={handleStartClick}>
                Start
              </button>
            )}
          </div>
